		...
		function setPageFormat($format, $orientation="P") {
			...
			if (is_string($format)) {
				...
				switch (strtoupper($format)){
					...
					case 'SRS_CV': {$format = array(612.00,411.00); break;}
					case 'LEGAL': {$format = array(612.00,1008.00); break;}
					case 'LONG': {$format = array(612.00,936.00); break;}
					case 'MBTC_CHECK': {$format = array(216.00,576.00); break;}
					case 'AUB_CHECK': {$format = array(576.00,216.00); break;}
