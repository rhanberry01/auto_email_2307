...
//	if (trigger.type=='submit' && !validate(trigger)) return false;
	tout = tout | 60000;	// default timeout value
	set_mark(tout>100000 ? 'progressbar.gif' : 'ajax-loader.gif');
...
//				if(!objElement) alert('No element "'+id+'"');
        ...
        // Write errors to the debug div.
		  ...
		  set_mark();
		  var Oldvalue=trigger.value;
		  setTimeout(function(){ trigger.disabled = false;  trigger.innerHTML = Oldvalue;}, 200);//-------------------------------to enable the button after loading.
