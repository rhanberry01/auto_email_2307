...
if(isset($_GET['NewPayment'])) {
	$_SESSION['page_title'] = _($help_context = "Debit Memo to AR");
	...
	if ($input_error == 1)
		unset($_POST['Process']);
															...
															{									
																...
																if (count($dm_ids) > 0) {
																$dm_trans_nos = implode(',',$dm_ids);
															
																$trans = process_dm_to_ar($dm_trans_nos,$_SESSION['pay_items']->trans_type, $_POST['bank_account'],
...
start_form();
display_dm_payment_header($_SESSION['pay_items']);		
