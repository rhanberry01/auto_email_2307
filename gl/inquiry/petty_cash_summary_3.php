...
$from_head = array('<input type="checkbox" id="select_all">',"SEQ#","Trans#","Date","Employee Name",'REF#','Payee','Purpose of Expense','TIN#');
...
if ($_POST['yes_no']==0) 
{
	...
	//end_row();	
	submit_cells('create_apv', 'Create CV', "align=center", true, false,'ok.gif'); // default async="true"
	end_table();
}
div_end();
end_form();
