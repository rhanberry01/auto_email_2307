...
$sql="SELECT DISTINCT supp_name FROM 0_dm_summary_from_2015_to_2017 WHERE supp_name='FAST TRAX CORPORATION (GULAMAN)' ORDER BY supp_name";
// display_error($sql);
$res = db_query($sql);
...
while($row = db_fetch($res))
{
	...
	label_cell(number_format2($t_dm_2015=abs(get_pen_dm_2015($row['supp_name']))));
