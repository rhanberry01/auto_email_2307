...
//display_error($_POST['payment_type']);
	...
	//$sql .= " AND bd_payment_type_id!=3 AND at.type=2 AND at.description='Paid' AND oh.bd_cleared='0' ORDER BY oh.bd_trans_date, oh.bd_trans_no";
	$sql .= " AND bd_payment_type_id!=3 AND oh.bd_cleared='0' ORDER BY oh.bd_trans_date, oh.bd_trans_no";
