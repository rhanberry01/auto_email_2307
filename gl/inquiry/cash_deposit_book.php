...
$sql .= " GROUP BY cd_payment_type_id,cd_cleared,cd_sales_date) as x
...
array_push($th,'Sales Date','Type','Sales from Cash','Amount Deposited', 'Cash in Bank','Uncleared','Discrepancy');
