...
if (isset($_POST['upload'])) 
{
	...
	if ($_POST['bank_account']=='10102299'){
		...
		$sql="select * from cash_deposit.".TB_PREF."bank_statement_aub where cleared='0' and date_deposited>='2016-01-01'  order by date_deposited";
		$res = db_query($sql);
		...
		while($row = db_fetch($result))
		{
				...
				WHERE sdc.dc_remittance_date>='2016-01-01' AND sdc.dc_remittance_date<='2016-01-31'
				AND (sdc.dc_card_desc='METROBANK' OR sdc.dc_card_desc='metrobank')
				AND sdc.processed='0' AND sdc.paid='0'
