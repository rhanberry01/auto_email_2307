				...
				display_error($counter);
					...
					// if ($counter>0) {
						...
						while($rowy = db_fetch($resx))
						{
							...
							label_cell(number_format2($t_dm_2015=abs(get_pen_dm_2015($rowy['supp_name']))));
							label_cell(number_format2($t_dm_2016=abs(get_pen_dm_2016($rowy['supp_name']))));
							label_cell(number_format2($t_dm_2017=abs(get_pen_dm_2017($rowy['supp_name']))));
