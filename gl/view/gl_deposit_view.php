...
function get_chk_details($trans_no)
{
	$sql = "SELECT ".TB_PREF."cheque_details.*, ".TB_PREF."bank_trans.*
			...
			AND ".TB_PREF."cheque_details.type = ".db_escape(ST_BANKDEPOSIT);
...
$result = get_bank_trans_2(ST_BANKDEPOSIT, $trans_no);
...
label_cells(_("Amount"), number_format2($to_trans['Total'], user_price_dec()), "class='tableheader2'", "align=right");
