...
page(_($help_context = "Invoice Deduction to OR"), false, false, "", $js);
...
if (isset($_POST['Add']))
{
	...
	// display_notification('Selected Invoice Deduction Succesfully Processed.');
	// }
	// else{
...
if (list_updated('supp_id') or isset($_POST['Add'])) {
	...
	//display_error($dm_count);
		...
		if ($dm_count>0) {
			...
			display_heading("Invoice Deduction List");
			br();
