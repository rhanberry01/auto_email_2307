	...
	if ($count>0){
		while($row = db_fetch($res))
		{
			if ($date_paid>=$row['bd_trans_date']){
							...
							if ($row['bd_id']!='') {
								update_other_income_payment_header2($row['bd_id'],$date_paid,$bank_statement_id,$bank_gl_code);
							}
							else{
	...
	if ($_POST['bank_account']=='10102299'){
		...
		while($row_ = db_fetch($result_))
		{
			$myBranchCode=$row_['code'];
				...
				$sql="select * from cash_deposit.".TB_PREF."bank_statement_aub where credit_amount!=0 and cleared='0' and date_deposited>='2016-01-01' and  date_deposited<='2016-12-31' order by date_deposited";
				$res = db_query($sql);
		...
		while($row_ = db_fetch($result_))
		{
			...
			$sql1="select * from cash_deposit.".TB_PREF."bank_statement_metro where credit_amount!=0 and cleared='0' and date_deposited>='2016-01-01' and date_deposited<='2016-12-31' order by date_deposited";
			$res1 = db_query($sql1);
