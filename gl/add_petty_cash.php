...
echo "<script language='JavaScript' type='text/javascript' src='../js/petty_cash_suggest_purpose.js'></script>";
echo "<script language='JavaScript' type='text/javascript' src='../js/petty_cash_suggest_payee.js'></script>";
...
$sql = "INSERT INTO ".TB_PREF."petty_cash_header(pc_date,pc_employee_id,pc_employee_name,pc_approved_by_id,pc_approved_by_name,pc_memo)
...
function insert_petty_cash_details($pc_id,$date_,$payee,$purpose,$gl_type,$ref,$tin,$tax,$tax_type,$prepared_by_id,$prepared_by_name)
{
global $path_to_root;
...
$sql = "INSERT INTO ".TB_PREF."petty_cash_details (pc_id,pcd_date_created,pcd_date,pcd_payee,pcd_purpose,pcd_gl_type,
...
if (isset($_POST['Approve'])){
	$sql = "UPDATE ".TB_PREF."petty_cash_header
	SET pc_approved = '1'
...
insert_petty_cash_details($_POST['pc_id'],$_POST['date'],$_POST['payee'],$_POST['purpose'],$_POST['rec_type'],$_POST['ref'],$_POST['tin'],$_POST['tax'],$_POST['tax_type'],$approver_id,$approver_real_name);
