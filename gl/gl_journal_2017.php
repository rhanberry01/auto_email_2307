...
if (isset($_POST['Process']))
{
	...
	if((date('Y-m-d',strtotime($_POST['date_'])) < '2016-12-31')){
		display_error(_("You must enter year 2017 only."));
		set_focus('code_id');
		$input_error = 1;
...
if (isset($_POST['Process']))
{
	...
	$trans_no = write_journal_entries_2017($cart, check_value('Reverse'),'',1);
	$cart->clear_items();
...
display_order_header_2017($_SESSION['journal_items']);
