...
if (isset($_POST['upload'])) 
{
	...
	if ($_POST['bank_account']=='10102299'){
		...
		$sql_ = "SELECT * from transfers.0_branches where code='srsnav'";
		//display_error($sql_);
		...
		while($row_ = db_fetch($result_))
		{
			//$myBranchCode=$row_['code'];
				...
				$sql1="select * from cash_deposit.".TB_PREF."bank_statement_aub where credit_amount!=0 and branch_code='$myBranchCode' and type=2 and cleared='1' and date_deposited>='2016-01-01' and  date_deposited<='2016-12-31' order by date_deposited";
				//display_error($sql1); 
		...
		while($row_ = db_fetch($result_))
		{
			//$myBranchCode=$row_['code'];
				...
				$sql1="select * from cash_deposit.".TB_PREF."bank_statement_metro where credit_amount!=0 and type=2 and cleared='1' and date_deposited>='2016-01-01' and  date_deposited<='2016-12-31' order by date_deposited LIMIT 1";
				//display_error($sql1); 
