...
if (isset($_POST['Process']))
{
	...
	*/	
	...
	if($_POST['new_old'] == ''){
		...
		$sql = "SELECT counter FROM srs_aria_nova.0_counter
				WHERE code = 'CP'";
				$res = db_query($sql);
				$row = db_fetch($res);
		...
		$saf = 'SRSSAFCP '.$ref;
		$sql = "INSERT INTO srs_aria_nova.0_c_payment_saf(reference,purchaserID) VALUES('".$saf."','".$_POST['purchaser']."')";
		$query = db_query($sql);
		
		$sql = "INSERT INTO srs_aria_nova.0_c_payment_saf_supp(reference,supplierCode) VALUES('".$saf."','".$_POST['supp_id']."')";
		$query = db_query($sql);
	}else{
