...
page(_($help_context = "Void a AP Voucher"), true, false, "", $js);
...
function voiding_controls()
{
	...
	ap_voucher_row(_("Transaction Type:"), "filterType", null, true);
...
function handle_void_transaction()
{
	...
	if (check_valid_entries()==true) 
	{
		...
		//mhae
		$ret = void_transaction_dis($_POST['filterType'], $_POST['trans_no'],
