...
{
	begin_transaction();
	$sql = "SELECT id FROM transfers.0_transfer_header WHERE m_id_in = $m_id AND br_code_in = '$branch' AND transfer_in_date>='2017-01-01' and transfer_in_date<='2017-12-31' and m_id_in NOT LIKE '%,%'";
	$res = db_query($sql);
	$row = db_fetch($res);
