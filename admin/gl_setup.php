...
if (isset($_POST['submit']) && can_process())
{
	update_company_gl_setup($_POST['retained_earnings_act'], $_POST['profit_loss_year_act'],
		...
		$_POST['creditors_act'],$_POST['creditors_act_nt'], $_POST['freight_act'],
		$_POST['exchange_diff_act'], $_POST['bank_charge_act'],
		$_POST['default_sales_act'],
		$_POST['default_sales_discount_act'],
		$_POST['default_sales_ewt_act'],
		$_POST['default_sales_tracking_charges_act'],
		...
		check_value('allow_credit_limit'),
		check_value('allow_so_edit'),
		check_value('allow_so_approval'),
		check_value('allow_voiding'),
		check_value('allow_po_editing'),
		check_value('allow_po_approval'),
		...
		$_POST['default_purchase_ewt_act'],
		$_POST['cash_bank_account'],
		$_POST['check_bank_account'],
		$_POST['purchase_vat'],
		$_POST['purchase_non_vat'],
		$_POST['rebate_act'],
		$_POST['online_payment_bank_id'],
		$_POST['pbcom_payment_bank_id']);
...
$_POST['creditors_act_nt']  = $myrow["creditors_act_nt"];
$_POST['purchase_non_vat']  = $myrow["purchase_non_vat"];
$_POST['purchase_vat']  = $myrow["purchase_vat"];
...
$_POST['default_sales_ewt_act']  = $myrow["default_sales_ewt_act"];
$_POST['default_sales_tracking_charges_act']  = $myrow["default_sales_tracking_charges_act"];
...
$_POST['allow_credit_limit'] = $myrow['allow_credit_limit'];
$_POST['allow_so_edit'] = $myrow['allow_so_edit'];
$_POST['allow_so_approval'] = $myrow['allow_so_approval'];
$_POST['allow_voiding'] = $myrow['allow_voiding'];
$_POST['allow_po_editing'] = $myrow['allow_po_editing'];
$_POST['allow_po_approval'] = $myrow['allow_po_approval'];
...
$_POST['default_purchase_ewt_act']  = $myrow["default_purchase_ewt_act"];

$_POST['cash_bank_account']  = $myrow["cash_bank_account"];
$_POST['check_bank_account']  = $myrow["check_bank_account"];
$_POST['rebate_act']  = $myrow["rebate_act"];
$_POST['online_payment_bank_id']  = $myrow["online_payment_bank_id"];
$_POST['pbcom_payment_bank_id']  = $myrow["pbcom_payment_bank_id"];
...
cash_accounts_list_row(_("Cash on Hand Account:"), 'cash_bank_account', null, false, false);

check_accounts_list_row(_("Check on Hand Account:"), 'check_bank_account', null, false, false);
//---------------
...
gl_all_accounts_list_row(_("Creditable Tax:"), 'default_sales_ewt_act', $_POST['default_sales_ewt_act']);

// gl_all_accounts_list_row(_("Tracking Charges Account:"), 'default_sales_tracking_charges_act', $_POST['default_sales_tracking_charges_act']);
...
table_section_title(_("Rebates to Supplier"));
gl_all_accounts_list_row(_("Rebate Account:"), 'rebate_act');

//----------------

table_section_title(_("Online Payment"));
bank_accounts_list_row(_("Bank Account:"), 'online_payment_bank_id');

table_section_title(_("Online Check Payment"));
bank_accounts_list_row(_("Bank Account:"), 'pbcom_payment_bank_id');
...
gl_all_accounts_list_row(_("Payable Account (Non-Trade):"), 'creditors_act_nt', $_POST['creditors_act_nt']);

gl_all_accounts_list_row(_("Purchase VAT:"), 'purchase_vat', $_POST['purchase_vat']);

gl_all_accounts_list_row(_("Purchase NON-VAT:"), 'purchase_non_vat', $_POST['purchase_non_vat']);

gl_all_accounts_list_row(_("Purchase Discount Account:"), 'pyt_discount_act', $_POST['pyt_discount_act']);

gl_all_accounts_list_row(_("Tax Witheld:"), 'default_purchase_ewt_act', $_POST['default_purchase_ewt_act']);

table_section_title(_("Transaction Approval"));

check_row(_("Allow Negative Inventory:"), 'allow_negative_stock', null);

check_row(_("Allow Credit Limit:"), 'allow_credit_limit', null);
check_row(_("Allow SO Editing:"), 'allow_so_edit', null);
check_row(_("Allow SO Approval:"), 'allow_so_approval', null);
check_row(_("Allow Voiding:"), 'allow_voiding', null);
check_row(_("Allow PO Editing:"), 'allow_po_editing', null);
check_row(_("Allow PO Approval:"), 'allow_po_approval', null);
