...
function adjust_gl_entry($m_id, $m_no, $nettotal,$branch)
{
	...
	AND transfer_in_date>='2017-01-01' and transfer_in_date<='2017-12-31' and m_id_in NOT LIKE '%,%'";
...
if (isset($_POST['fix_now']))
{
	...
	while($row = mssql_fetch_array($res))
	{
		...
		//4. IF WALANG GINAWA PROGRAM, IDISPLAY YUNG MOVEMENT NUMBER THEN INVESTIGATE SOURCE OF TRANSACTION.
		// if ($stats3 == 0)
		// {
