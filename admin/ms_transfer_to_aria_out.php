...
{
	$sql = "SELECT MovementID,MovementNo FROM Movements WHERE MovementCode = 'STO' and TransactionDate>='2017-01-01 00:00:00' AND TransactionDate<='2017-12-31 00:00:00'";
