...
function check_my_items($line_item)
{
	...
	{
		display_error('Product ID : '. $stock_id . ' not in MSSQL Products table');die;
		return false;
	}
		...
		// {
			...
			if ($rr_id > 0 AND !is_array($rr_id)) // rr id
			{
				...
				if ($num_row>0)
				{
								...
								{
									create_apv_from_rr($rr_id,$cwo_amount,24);
									create_apv_from_rr($rr_id,$grn_amount-$cwo_amount);
								}
				}
				//+++++++++++++++++++++++++++++++++++++++++++++++++INSERTED for cwo	
				else 
