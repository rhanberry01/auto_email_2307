...
function get_rs_header_by_branch($rs_id, $branch_id) {
...
function get_rs_items_by_branch($rs_id, $branch_id) {
...
$row = get_rs_header_by_branch($_GET['rs_id'], $_GET['bid']);
$remarks=$row['comment'];
...
$res = get_rs_items_by_branch($rs_id, $_GET['bid']);
