...
display_heading(_("Discrepancy in Purchase Order"));
...
display_heading2(_("Incomplete Items"));

start_table("colspan=9 $table_style width=100%");
//_("Date Required"),
$th = array(_("Item Code"), _("Item Description"),  _("Unit"), _("Price"),'Discounts',
	_("Amount"),  _("Quantity Ordered"), _("QTY Received"), _("QTY Invoiced"));
...
{
	if ($stock_item->quantity == $stock_item->qty_received)
		continue;
	...
	qty_cell($stock_item->quantity, true, $dec);
	qty_cell($stock_item->qty_received, true, $dec);
...
label_row(_("<b>Total</b>"), '<b>'.price_format($total).'</b>', "colspan=5 align=right", "nowrap align=right", 2);
