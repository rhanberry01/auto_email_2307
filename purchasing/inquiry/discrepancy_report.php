...
function invoice_attachment_link($row) 
{	
	if(get_po_attachment($row['reference'])){
			return 	"<a target=blank href='".get_po_attachment($row['reference'])."'onclick=\"javascript:openWindow(href,target); return false;\">"._("View Invoice") . "&nbsp;</a> ";
	}
	else{
		return "Not Found";		
	}
...
$cols = array(
	...
	_("Attachment") => array('fun'=>'invoice_attachment_link'), 
	_("Invoice #") => array('ord'=>''),
