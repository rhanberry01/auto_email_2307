...
{	
	if ($row['resolved_by'] == 0)
		return pager_link( _("Edit"),"/purchasing/discrepancy_fix_2.php?". SID. "discrepancy_id=" . $row["id"], ICON_EDIT);
	// else
...
$th = array();
		array_push($th,'', 'PO #','Invoice#','Date','Supplier','Receiving#','Trans#','PO Price','Invoice Amount','Discrepancy', 'Update Prices');
...
while($row = db_fetch($res))
{
	...
	label_cell(edit_link($row),'align=center');
	//}
