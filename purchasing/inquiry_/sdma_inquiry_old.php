...
$th = array('#', 'Reference','PO #', 'Date Created', 'Supplier', 'Branch', 'Type', 'Amount', 'Effectivity','Comment',
...
foreach ($all_branch as $key => $row) 
{
	...
	if ($row['approval_1'] == 0 AND !$_SESSION['wa_current_user']->can_approve_sdma_1) {
		...
		echo '<td align="center">
				...
				<button type="submit" class="editbutton" name="approve_sdma1'.$row['id'].'" value="1" title="Approve"><img src="../../themes/modern/images/button_ok.png" width="12" height="12" border="0">
				</button>
			</td>';
	}
	else {
	...
	else if ($row['approval_2'] == 0 AND $_SESSION['wa_current_user']->can_approve_sdma_2)
	{
		if ($row['approval_1'] == 0) {
			...
			echo '<td align="center">
				...
				<button type="submit" class="editbutton" name="approve_sdma2'.$row['id'].'" value="1" title="Approve"><img src="../../themes/modern/images/button_ok.png" width="12" height="12" border="0">
				</button>
			</td>';
		}
	}
