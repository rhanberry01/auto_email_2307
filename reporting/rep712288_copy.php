...
SELECT 'BANK' as trans_types,'CR_DR CARD RECONCILED'  as description,sum(credit_amount) as amount FROM cash_deposit.$bank_table
where credit_amount > 0
and cleared=1
and type=62
and date_deposited>='".date2sql($from)."'
...
SELECT 'BOOK' as trans_types,'CR_DR CARD RECONCILED' as description,sum(amount) as amount FROM
(
...
where gl.type=62 AND dimension_id  ='99'
and gl.account='".$bank_account_code."'
and gl.tran_date>='".date2sql($from)."'  and gl.tran_date<='".date2sql($to)."'
and gl.amount>0
...
SELECT 'BOOK' as trans_types,'CR_DR CARD UNRECONCILED' as description,sum(amount) as amount FROM
(
SELECT 'srsal' as br_code, 'alaminos' as branch, ad.*,gl.amount as amount FROM srs_aria_alaminos.`0_gl_trans` as gl 
LEFT JOIN srs_aria_alaminos.0_acquiring_deductions as ad
on gl.type_no=ad.p_ref_id
...
where credit_amount!=0 and cleared=0
and date_deposited>='".date2sql($from)."'
and date_deposited<='".date2sql($to)."'
