...
function print_audit_trail()
{
    ...
    while ($myrow=db_fetch($trans))
    {
        ...
        $rep->TextCol(5, 6, get_reference($myrow['type'],$myrow['trans_no']));
		...
		if ($myrow['type'] == 30 AND $myrow['description'] != '')
		{
				
				$str = $rep->TextCol(1, 8, $myrow['description']);
				$rep->NewLine(1, 2);
				
				while($str != '')
				{
					$str = $rep->TextCol(1, 8, $str);
					$rep->NewLine(1, 2);
				}
		}
    }
