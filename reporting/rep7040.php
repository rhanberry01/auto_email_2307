...
function print_GL_transactions()
{
	...
	$destination = $_POST['PARAM_5'];
		...
		$sql = "SELECT account_code,account_name FROM ".TB_PREF."chart_master WHERE account_type=8";
		$res=db_query($sql);
	...
	$rep = new FrontReport(_('Operating Expense'), "OperatingExpense", user_pagesize(),9 ,'L');
	$dec = user_price_dec();
