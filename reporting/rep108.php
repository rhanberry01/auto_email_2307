...
function print_statements()
{
	...
	while ($myrow=db_fetch($result))
	{
		...
		{
			include_once($path_to_root . "/reporting/includes/doctext2.inc");
		}
		else
		{
			include_once($path_to_root . "/reporting/includes/doctext.inc");
		}
		$rep->fontSize += 2;
		...
		while ($myrow2=db_fetch($TransResult))
		{
			...
			if ($myrow2['type'] == ST_SALESINVOICE||$myrow2['type'] == ST_CUSTCREDITMEMO)
