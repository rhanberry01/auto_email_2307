...
function print_report()
{
    ...
    $rep = new FrontReport(_('Debit Memo Book'), "DebitMemoBook ".$com['coy_name'], "LETTER");
	...
	$rep->y ++;
	$rep->sheet->writeString($rep->y, 0, 'DEBIT MEMO BOOK', $format_bold);
	$rep->y ++;
...
'1440'
		...
		array_push($c_header,'2000','2000010',
'5500',
'2471',
'2473',
'2478',
...
'1440'
	...
	$sql = "SELECT DISTINCT st.tran_date, st.supplier_id, st.reference, st.supp_reference, 
	...
	$sql .="  gl.tran_date >= '".date2sql($from)."'
	...
	$rep->y ++;
	$rep->sheet2->writeString($rep->y, 0, 'DEBIT MEMO BOOK', $format_bold);
	$rep->y ++;
