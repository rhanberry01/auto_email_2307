...
function print_report()
{
    ...
    $params =   array( 	0 => '',
      ...
      $rep = new FrontReport(_('CASH_DEPOSIT_RECONCILED'), "METROBANK_BankRecon_DEPOSIT", "LETTER");
	...
	$rep->y ++;
	$rep->sheet->writeString($rep->y, 0, 'METROBANK Bank Recon (Cash Deposit)', $format_bold);
	$rep->y ++;
...
// '2000105'
	...
	$rep->y ++;
	$rep->sheet2->writeString($rep->y, 0, 'METROBANK Bank Recon (Cash Deposit)', $format_bold);
	$rep->y ++;
...
where cd_cleared=0
and cd_bank_account_code='1020021'
";
...
//display_error($sql); die;
	...
	$rep->y ++;
	$rep->sheet3->writeString($rep->y, 0, 'METROBANK Bank Recon (Other Income)', $format_bold);
	$rep->y ++;
...
//display_error($sql); die;
	...
	$rep->y ++;
	$rep->sheet4->writeString($rep->y, 0, 'METROBANK Bank Recon (Other Income)', $format_bold);
	$rep->y ++;
...
//display_error($sql); die;
	...
	$rep->y ++;
	$rep->sheet5->writeString($rep->y, 0, 'METROBANK Bank Recon (Other Income)', $format_bold);
	$rep->y ++;
...
//display_error($sql); die;
	...
	$rep->y ++;
	$rep->sheet6->writeString($rep->y, 0, 'METROBANK Bank Recon (Credit/Debit Card)', $format_bold);
	$rep->y ++;
...
//display_error($sql); die;
	...
	$rep->y ++;
	$rep->sheet7->writeString($rep->y, 0, 'METROBANK Bank Recon (Credit/Debit Card)', $format_bold);
	$rep->y ++;
