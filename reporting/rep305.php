...
function getTransactions($from, $to)
{
	...
	$sql = "SELECT DISTINCT ".TB_PREF."grn_batch.supplier_id, 
            ".TB_PREF."purch_order_details.*,".TB_PREF."purch_orders.reference,
...
function print_grn_valuation()
{
	...
	$headers = array(_('Item Code'), _('Description'), _('PO No'), _('Qty Received'), _('Unit Price'), _('Actual Price'), _('Total'));
