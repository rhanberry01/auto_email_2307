...
function print_list_of_journal_entries()
{
    ...
    $rep = new FrontReport(_('PromoFund Liabilities Bundling'), "JournalEntries", user_pagesize());
    ...
    $trans ="
			...
			WHERE glt.memo_ like '%products for bundling, SAF NO%'
			and glt.tran_date >='".date2sql($from)."' and glt.tran_date <='".date2sql($to)."'
			and glt.type = '53' and account ='2478' 
