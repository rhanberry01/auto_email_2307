...
function print_pdcc_for_payments()
{
	...
	$headers = array('Branch', '#', 'Date', 'Reference', 'Amount   ', 'Remarks'); //'Supplier',
    ...
    $rep = new FrontReport(_('Supplier Debit Memos from 2015 to Present'), "SuppDM", user_pagesize());
	...
	$sql = "SELECT *  FROM srs_aria_nova.0_dm_summary_from_2015_to_present";
	...
	else
	{
		...
		while($myrow = db_fetch($res))
		{
			...
			$supp_rows[] = array(
				...
				html_entity_decode(html_entity_decode($myrow['branch_code']))
			);
