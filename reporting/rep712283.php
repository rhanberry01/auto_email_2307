...
function print_report()
{
    ...
    $params =   array( 	0 => '',
      ...
      $rep = new FrontReport(_('UNRECORDED'), "METRO_BankRecon_CR_DR_CARD", "LETTER");
	...
	$rep->y ++;
	$rep->sheet->writeString($rep->y, 0, 'METROBANK Bank Recon (Credit/Debit Card)', $format_bold);
	$rep->y ++;
...
// '2000105'
	...
	$rep->y++;
			...
			$rep->sheet3 = $rep->addWorksheet('NOT IN METROBANK BANK STATEMENT');
	...
	$rep->y ++;
	$rep->sheet3->writeString($rep->y, 0, 'METROBANK Bank Recon (Credit/Debit Card)', $format_bold);
	$rep->y ++;
...
SELECT 'srscom' as br_code,'comembo' as branch,ad.*,gl.amount as amount FROM `0_gl_trans` as gl 
...
//display_error($sql); die;
	...
	$rep->y++;
			...
			$rep->sheet4 = $rep->addWorksheet('IN METROBANK BANK STATEMENT');
	...
	$rep->y ++;
	$rep->sheet4->writeString($rep->y, 0, 'METROBANK Bank Recon (Credit/Debit Card)', $format_bold);
	$rep->y ++;
...
//display_error($sql); die;
	...
	// foreach ($c_totals as $ind => $total)
	// {
		$rep->sheet4->writeNumber ($rep->y, 3, $total3, $format_bold_right);
