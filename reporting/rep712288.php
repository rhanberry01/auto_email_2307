...
function print_report()
{
    ...
    $params =   array( 	0 => '',
      ...
      $rep = new FrontReport(_('SUMMARY'), $bank_name." BANK RECON DEPOSIT SUMMARY ", "LETTER");
...
//===================================================================================
	...
	$sql="
SELECT 'BOOK' as trans_types,'CASH DEPOSIT RECONCILED' as description, SUM(amount) as amount, 0 as deposit_over FROM (
...
and  gl_aria.amount > 0 and chn.cd_gross_amount > 0 
UNION ALL
select 'manggahan' as branch,gl_aria.amount,gl_aria.tran_date,'RECONCILED'  from srs_aria_manggahan.0_gl_trans as gl_aria
LEFT JOIN cash_deposit.0_cash_dep_header_new as chn
on gl_aria.type_no = chn.cd_id and gl_aria.type = chn.cd_trans_type
where  gl_aria.tran_date >='".date2sql($from)."' and gl_aria.tran_date <='".date2sql($to)."'
and gl_aria.account ='".$bank_account_code."' and chn.cd_bank_account_code ='".$bank_account_code."' and gl_aria.type = '101' and chn.cd_cleared = 1
...
SELECT 'BANK' as trans_types,'CASH DEPOSIT RECONCILED' as description,sum(credit_amount) as amount,sum(under_over_deposit) as deposit_over FROM cash_deposit.$bank_table
...
SELECT 'BOOK' as trans_types,'CASH DEPOSIT UNRECONCILED' as description, SUM(amount) as amount, 0 as deposit_over FROM (
select 'alaminos' as branch,gl_aria.amount,gl_aria.tran_date,'RECONCILED'  from srs_aria_alaminos.0_gl_trans as gl_aria
LEFT JOIN cash_deposit.0_cash_dep_header_new as chn
on gl_aria.type_no = chn.cd_id and gl_aria.type = chn.cd_trans_type
where  gl_aria.tran_date >='".date2sql($from)."' and gl_aria.tran_date <='".date2sql($to)."' 
...
SELECT 'BOOK' as trans_types,'BANK DEPOSIT RECONCILED' as description, sum(amount) as amount, 0 as deposit_over from
(
...
SELECT 'srsman' as br_code,'manggahan' as branch,oi.*,gl.amount as amount 
...
SELECT 'BANK' as trans_types,'BANK DEPOSIT RECONCILED' as description,sum(credit_amount) as amount,sum(under_over_deposit) as deposit_over FROM cash_deposit.$bank_table
where credit_amount > 0
and cleared=1
and type=2
and date_deposited>='".date2sql($from)."'
...
SELECT 'BOOK' as trans_types,'BANK DEPOSIT  UNRECONCILED' as description, sum(amount) as amount, 0 as deposit_over from
(
SELECT 'srsal' as br_code, 'alaminos' as branch,oi.*,gl.amount as amount 
FROM srs_aria_alaminos.0_gl_trans as gl 
LEFT JOIN srs_aria_alaminos.0_other_income_payment_header as oi
...
SELECT 'BOOK' as trans_types,'SALES TOTAL RECONCILED' as description,sum(amount) as amount, 0 as deposit_over FROM
...
SELECT 'BANK' as trans_types,'SALES TOTAL RECONCILED' as description,sum(credit_amount) as amount,sum(under_over_deposit) as deposit_over FROM cash_deposit.$bank_table
where credit_amount > 0
and cleared=1
and type=60
and date_deposited>='".date2sql($from)."'
...
SELECT 'BOOK' as trans_types,'SALES TOTAL UNRECONCILED' as description,sum(amount) as amount, 0 as deposit_over FROM
(SELECT 'srs_aria_retail' as br_code,'srs_aria_retail' as branch, 0_gl_trans.*
FROM srs_aria_retail.0_gl_trans
WHERE tran_date >= '".date2sql($from)."'
AND  tran_date <= '".date2sql($to)."' 
...
SELECT 'BOOK' as trans_type,'JOURNAL RECONCILED' as description,sum(amount) as amount, 0 as deposit_over FROM
(SELECT 'srs_aria_retail' as br_code,'srs_aria_retail' as branch, 0_gl_trans.*
FROM srs_aria_retail.0_gl_trans
WHERE tran_date >= '".date2sql($from)."'
AND  tran_date <= '".date2sql($to)."' 
...
SELECT 'BANK' as trans_types,'JOURNAL RECONCILED' as description, sum(credit_amount) as amount,sum(under_over_deposit) as deposit_over FROM cash_deposit.$bank_table
where credit_amount > 0
and cleared=1
and type=0
and date_deposited>='".date2sql($from)."'
...
SELECT 'BOOK' as trans_type,'JOURNAL UNRECONCILED' as description,sum(amount) as amount, 0 as deposit_over FROM
(SELECT 'srs_aria_retail' as br_code,'srs_aria_retail' as branch, 0_gl_trans.*
FROM srs_aria_retail.0_gl_trans
WHERE tran_date >= '".date2sql($from)."'
AND  tran_date <= '".date2sql($to)."' 
...
SELECT 'BOOK' as trans_types,'OUTSTANDING CHECKS RECONCILED' as description,sum(amount) as amount, 0 as deposit_over FROM
(SELECT 'srs_aria_retail' as br_code,'srs_aria_retail' as branch, 0_gl_trans.*
FROM srs_aria_retail.0_gl_trans
WHERE tran_date >= '".date2sql($from)."'
AND  tran_date <= '".date2sql($to)."' 
...
SELECT 'BANK' as trans_types,'OUTSTANDING CHECKS RECONCILED' as description,sum(credit_amount) as amount,sum(under_over_deposit) as deposit_over FROM cash_deposit.$bank_table
where credit_amount > 0
and cleared=1
and type=7
and date_deposited>='".date2sql($from)."'
...
SELECT 'BOOK' as trans_types,'OUTSTANDING CHECKS UNRECONCILED' as description,sum(amount) as amount, 0 as deposit_over FROM
(SELECT 'srs_aria_retail' as br_code,'srs_aria_retail' as branch, 0_gl_trans.*
FROM srs_aria_retail.0_gl_trans
WHERE tran_date >= '".date2sql($from)."'
AND  tran_date <= '".date2sql($to)."' 
...
SELECT 'BOOK' as trans_types,'STALED CHECKS RECONCILED' as description,sum(amount) as amount, 0 as deposit_over FROM
(SELECT 'srs_aria_retail' as br_code,'srs_aria_retail' as branch, 0_gl_trans.*
FROM srs_aria_retail.0_gl_trans
WHERE tran_date >= '".date2sql($from)."'
AND  tran_date <= '".date2sql($to)."' 
...
SELECT 'BANK' as trans_types,'STALED CHECKS RECONCILED'  as description,sum(credit_amount) as amount,sum(under_over_deposit) as deposit_over FROM cash_deposit.$bank_table
where credit_amount > 0
and cleared=1
and type=6
and date_deposited>='".date2sql($from)."'
...
SELECT 'BOOK' as trans_types,'STALED CHECKS UNRECONCILED' as description,sum(amount) as amount, 0 as deposit_over FROM
(SELECT 'srs_aria_retail' as br_code,'srs_aria_retail' as branch, 0_gl_trans.*
FROM srs_aria_retail.0_gl_trans
WHERE tran_date >= '".date2sql($from)."'
AND  tran_date <= '".date2sql($to)."'
...
SELECT 'BOOK' as trans_types,'APV RECONCILED' as description,sum(amount) as amount, 0 as deposit_over 
FROM
(SELECT 'srs_aria_retail' as br_code,'srs_aria_retail' as branch, 0_gl_trans.*
FROM srs_aria_retail.0_gl_trans
WHERE tran_date >= '".date2sql($from)."'
...
WHERE tran_date >= '".date2sql($from)."'
AND  tran_date <= '".date2sql($to)."'
AND account ='".$bank_account_code."' AND amount>0 AND type=20 AND dimension_id  ='99') as q


UNION ALL

SELECT 'BOOK' as trans_types,'APV UNRECONCILED' as description,sum(amount) as amount, 0 as deposit_over 
FROM
(SELECT 'srs_aria_retail' as br_code,'srs_aria_retail' as branch, 0_gl_trans.*
FROM srs_aria_retail.0_gl_trans
WHERE tran_date >= '".date2sql($from)."'
...
SELECT 'BOOK' as trans_types,'BAYAD CENTER RECONCILED' as description,sum(amount) as amount ,0 as deposit_over
FROM
(SELECT 'srs_aria_retail' as br_code,'srs_aria_retail' as branch, 0_gl_trans.*
FROM srs_aria_retail.0_gl_trans
WHERE tran_date >= '".date2sql($from)."'
...
UNION ALL
	...
	SELECT 'BANK' as trans_types,'BAYAD CENTER RECONCILED' as description,sum(credit_amount) as amount,sum(under_over_deposit) as deposit_over FROM cash_deposit.$bank_table
	where credit_amount > 0
	and cleared=1
	and type='74'
	and date_deposited>='".date2sql($from)."'
...
SELECT 'BOOK' as trans_types,'BAYAD CENTER UNRECONCILED' as description,sum(amount) as amount ,0 as deposit_over
FROM
(SELECT 'srs_aria_retail' as br_code,'srs_aria_retail' as branch, 0_gl_trans.*
FROM srs_aria_retail.0_gl_trans
WHERE tran_date >= '".date2sql($from)."'
...
SELECT 'BOOK' as trans_types,'CR_DR CARD RECONCILED' as description,sum(amount) as amount, 0 as deposit_over FROM
(
...
where gl.type=62 AND ad.reconciled = 1
and gl.account='".$bank_account_code."'
and gl.tran_date>='".date2sql($from)."'  and gl.tran_date<='".date2sql($to)."'
and gl.amount>0
...
SELECT 'srsman' as br_code,'manggahan' as branch,ad.*,gl.amount as amount FROM srs_aria_manggahan.`0_gl_trans` as gl 
...
SELECT 'BANK' as trans_types,'CR_DR CARD RECONCILED'  as description,sum(credit_amount) as amount,sum(under_over_deposit) as deposit_over FROM cash_deposit.$bank_table
where credit_amount > 0
and cleared=1
and type=62
and date_deposited>='".date2sql($from)."'
...
SELECT 'BOOK' as trans_types,'CR_DR CARD UNRECONCILED' as description,sum(amount) as amount, 0 as deposit_over FROM
(
SELECT 'srsal' as br_code, 'alaminos' as branch, ad.*,gl.amount as amount FROM srs_aria_alaminos.`0_gl_trans` as gl 
LEFT JOIN srs_aria_alaminos.0_acquiring_deductions as ad
on gl.type_no=ad.p_ref_id
...
SELECT 'BANK' as trans_types,'BANK CREDIT UNRECONCILED' as description, sum(credit_amount) as amount,sum(under_over_deposit) as deposit_over FROM cash_deposit.$bank_table
where credit_amount!=0
and cleared=0
and date_deposited>='".date2sql($from)."'
and date_deposited<='".date2sql($to)."'
