...
function print_picking_list()
{
	...
	$cols = array(0, 100,  380, 460, 540);
	$headers = array(_('Barcode'), _('Description'),'Units',  'Quantity');
	$aligns = array('left', 'left', 'center', 'center', 'right');


	$tr_header = get_transfer_header($trans_id,1);
    ...
    $params =   array( 	0 => $comments,
						...
						5 => array('text' => _('Checked By: '), 'from' => strtoupper($tr_header['checked_by']) , 'to' =>''),
						6 => array('text' => _('Delivered By: '), 'from' => strtoupper($tr_header['delivered_by']) , 'to' =>'')
						);


    $rep = new FrontReport("Transfer # $trans_id", "Picking_List_Transfer_$trans_id", user_pagesize());
	...
	$res = get_for_transfer_items($trans_id,1);
