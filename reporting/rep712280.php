...
function print_report()
{
    ...
    $params =   array( 	0 => '',
      ...
      $rep = new FrontReport(_('CASH_DEPOSIT_RECONCILED'), "AUB_BankRecon_DEPOSIT", "LETTER");
...
//display_error($sql); die;
	...
	$rep->y++;
			...
			$rep->sheet6 = $rep->addWorksheet('RECONCILED JOURNAL ' );
...
//display_error($sql); die;
	...
	$rep->y++;
				...
				$rep->sheet7 = $rep->addWorksheet('JOURNAL');
	...
	$rep->y ++;
	$rep->sheet7->writeString($rep->y, 0, 'AUB Bank Recon (Payment)', $format_bold);
	$rep->y ++;
...
//display_error($sql); die;
	...
	// foreach ($c_totals as $ind => $total)
	// {
		$rep->sheet7->writeNumber ($rep->y, 7, $total6, $format_bold_right);
