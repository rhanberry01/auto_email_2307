...
function print_report()
{
    ...
    $params =   array( 	0 => '',
      ...
      $rep = new FrontReport(_('RECONCILED'), "BDO_BankRecon_CHECK", "LETTER");
	...
	$rep->y ++;
	$rep->sheet->writeString($rep->y, 0, 'BDO Bank Recon (Payment)', $format_bold);
	$rep->y ++;
...
//display_error($sql); die;
	...
	$rep->y ++;
	$rep->sheet2->writeString($rep->y, 0, 'BDO Bank Recon (Payment)', $format_bold);
	$rep->y ++;
...
//display_error($sql); die;
	...
	$rep->y ++;
	$rep->sheet3->writeString($rep->y, 0, 'BDO Bank Recon (Payment)', $format_bold);
	$rep->y ++;
...
//display_error($sql); die;
	...
	$rep->y ++;
	$rep->sheet4->writeString($rep->y, 0, 'BDO Bank Recon (Payment)', $format_bold);
	$rep->y ++;
