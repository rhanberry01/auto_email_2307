...
function get_invoices($customer_id, $to)
{
	...
	$sql = "SELECT ".TB_PREF."debtor_trans.type, ".TB_PREF."debtor_trans.reference,
		".TB_PREF."debtor_trans.tran_date, (TO_DAYS('$todate') - TO_DAYS($due))+1 as aged,
		$value as Balance,
		...
		WHERE ".TB_PREF."debtor_trans.type <> ".ST_CUSTDELIVERY."
			...
			AND ".TB_PREF."debtor_trans.tran_date <= '$todate' AND alloc<$value2 AND (".TB_PREF."debtor_trans.type=".ST_SALESINVOICE." OR ".TB_PREF."debtor_trans.type=".ST_CUSTPAYMENT.")
			AND ABS(
...
function get_customer_details_16($customer_id, $to=null)
{
	...
	-1, 1) *".
      "(".TB_PREF."debtor_trans.ov_gst +  ".TB_PREF."debtor_trans.ov_freight + ".TB_PREF."debtor_trans.ov_freight_tax + ".TB_PREF."debtor_trans.ov_discount + ".TB_PREF."debtor_trans.ewt + ".TB_PREF."debtor_trans.tracking +
			...
			) - ".TB_PREF."debtor_trans.alloc* IF(0_debtor_trans.type=12,-1,1) ";
	$value2 = "IF(".TB_PREF."debtor_trans.type=11 OR ".TB_PREF."debtor_trans.type=2,
	-1, 1) *".
      "(".TB_PREF."debtor_trans.ov_gst +  ".TB_PREF."debtor_trans.ov_freight + ".TB_PREF."debtor_trans.ov_freight_tax + ".TB_PREF."debtor_trans.ov_discount + ".TB_PREF."debtor_trans.ewt + ".TB_PREF."debtor_trans.tracking +
				(".TB_PREF."debtor_trans.ov_amount
				)
...
function print_aged_customer_analysis()
{
    ...
    $rep = new FrontReport(_('Aged Customer Analysis'), "AgedCustomerAnalysis", user_pagesize(),9,'L');
	...
	while ($myrow=db_fetch($result))
	{
		...
		$custrec = get_customer_details_16($myrow['debtor_no'], $to);
		...
		if (!$summaryOnly)
		{
			...
			$rep->TextCol(3, 4,	"Trans Date");
			$rep->TextCol(4, 5,	"Aging");
