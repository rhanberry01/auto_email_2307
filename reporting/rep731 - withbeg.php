...
// and cv_id=0";
	...
	// $sql = "SELECT DISTINCT c.type, c.trans_no, b.gst_no, b.supp_name, b.supplier_id,
	    ...
	    $bfw = get_gl_balance_from_to($from_2, $from ,2000, $_POST['Dimension'], $_POST['Dimension2']);
		
					$rep->TextCol(0, 1,	'Beginning Balance');
					$rep->TextCol(1, 2, $from);
					$rep->TextCol(2, 3, '');
					$rep->AmountCol(3, 4, $bfw,2);
					$rep->AmountCol(4, 5, 0,2);
					$rep->AmountCol(5, 6, 0,2);
					$rep->AmountCol(6, 7, 0,2);
					$rep->AmountCol(7, 8, 0,2);
					$rep->AmountCol(8, 9, 0,2);
	...
	$rep->AmountCol(3, 4, $ov_total+$bfw,2);
