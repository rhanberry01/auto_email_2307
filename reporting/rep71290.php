...
function print_report()
{
    ...
    $params =   array( 	0 => '',
      ...
      $rep = new FrontReport(_('SUPPLIERS PAY RECONCILED'), $bank_name." Disbursement Reconciliation Details", "LETTER");
	...
	$rep->y ++;
	$rep->sheet->writeString($rep->y, 0, $branch_name.' (Payment)', $format_bold);
	$rep->y ++;
...
$sql_aub ="
        SELECT *
		FROM
		(select   'srs_aria_alaminos' as branch_ ,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select      'srs_aria_antipolo_manalo' as branch_ ,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select     'srs_aria_antipolo_quezon' as branch_ ,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select      'srs_aria_b_silang' as branch_ ,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select     'srs_aria_bagumbong' as branch_ ,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select     'srs_aria_blum' as branch_ ,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select     'srs_aria_cainta' as branch_ ,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select     'srs_aria_cainta_san_juan' as branch_ ,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select     'srs_aria_camarin' as branch_ ,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select      'srs_aria_comembo' as branch_ ,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select      'srs_aria_gala' as branch_ ,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select      'srs_aria_graceville' as branch_ ,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select     'srs_aria_hero' as branch_ ,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select     'srs_aria_imus' as branch_ ,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select     'srs_aria_malabon' as branch_,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select     'srs_aria_malabon_rest' as branch_,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select      'srs_aria_molino' as branch_,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select      'srs_aria_navotas' as branch_,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select      'srs_aria_nova' as branch_,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select    'srs_aria_pateros' as branch_,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select 'srs_aria_punturin_val' as branch_,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select  'srs_aria_retail' as branch_,cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select  'srs_aria_san_pedro' as branch_,  cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select   'srs_aria_talon_uno' as branch_, cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select 'srs_aria_tondo' as branch_,  cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select 'srs_aria_valenzuela' as branch_, cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select 'srs_aria_manggahan' as branch_, cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
		...
		select 'srs_aria_montalban' as branch_, cds.chk_number,cds.chk_amount,bts.bank_act,bts.trans_date, bts.id as b_id, 
...
";
	...
	$rep->y++;
		...
		$rep->sheet2 = $rep->addWorksheet('SUPPLIERS PAY UNRECONCILED');
...
//display_error($sql); die;
	...
	$rep->sheet3 = $rep->addWorksheet('JV RECONCILED');
...
//display_error($sql); die;
	...
	//}
		...
		$rep->sheet4 = $rep->addWorksheet('JV UNRECONCILED');
...
//display_error($sql); die;
	...
	$rep->sheet5 = $rep->addWorksheet('BANK DEBIT UNRECONCILED');
	...
	$rep->y ++;
	$rep->sheet5->writeString($rep->y, 0, $bank_name.'(Payment)', $format_bold);
	$rep->y ++;
...
//===================================================================================
	...
	// get the header
	$c_header = array('BRANCH','REFRENCE','CV DATE','AMOUNT.', 'STATUS');
	$c_header_last_index = count($c_header)-1;
//	print_r($c_header_last_index = count($c_header)-1);
...
//display_error($sql); die;
	...
	while($row = db_fetch($res))
	{
		...
		$c_details[$count][3] = $row['debit_amount'];
		$c_details[$count][4] = 'UNRECONCILED';
		
		$total5+=$row['debit_amount'];	
	...
	$rep->sheet6 = $rep->addWorksheet('REVERSAL RECONCILED');
...
//display_error($sql); die;
	...
	$rep->y ++;
	$rep->sheet6->writeString($rep->y, 2, 'TOTAL', $format_bold_right);
	$qwert = $rep->y;
	// foreach ($c_totals as $ind => $total)
	// {
		$rep->sheet6->writeNumber ($rep->y, 3, $total6, $format_bold_right);
