...
function get_invoices($supplier_id, $to)
{
	...
	$sql = "SELECT ".TB_PREF."supp_trans.type, TO_DAYS('$todate') - TO_DAYS($due)+1 as aged,
		...
		FROM ".TB_PREF."suppliers,
	   	...
	   	WHERE ".TB_PREF."suppliers.payment_terms = ".TB_PREF."payment_terms.terms_indicator
			...
			AND ".TB_PREF."supp_trans.tran_date <= '$todate' AND alloc<$value2 AND ".TB_PREF."supp_trans.type=".ST_SUPPINVOICE."
...
function print_aged_supplier_analysis()
{
    ...
    $rep = new FrontReport(_('Aged Supplier Analysis'), "AgedSupplierAnalysis", user_pagesize(),9,'L');
