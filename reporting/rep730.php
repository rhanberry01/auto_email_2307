...
function get_consignment_transactions($year,$month,$vat_stat)
{
	if ($vat_stat==0){
		$vat_stat=1;
	}
	...
	chs.t_cos as t_cos, chs.t_sales as t_sales from ".TB_PREF."cons_sales_header  as chs
...
function print_list_of_journal_entries()
{
    ...
    $trans = get_consignment_transactions($year,$month,$vat_stat);
