...
if (!isset($path_to_root) || isset($_GET['path_to_root']) || isset($_POST['path_to_root']))
	...
	// Main Title
	$app_title = "Accounting Receiving and Inventory Administration (ARIA)";
	// application version
	$version 		= "3.10";
	...
	// Powered by
	$power_by 		= "San Roque Supermarket";
	$power_url 		= "http://www.intellitech.com.ph";
	...
	$check_qty_charged_vs_del_qty = false;
...
if (!defined('ICON_EDIT'))
{
	...
	define("ICON_VIEW", "view.gif");	
 	...
 	define("ICON_APPROVE", "button_ok.png");	
