...
page("Credit Card/Debit Card Reconciliation (Cr/Dr Card Entry)", false, false, "", $js);
//------------------------------------------------------------------------------------------------
...
display_notification('New Cr/Dr transaction has been added.');
return true;
//header("Location: ../inquiry/acquiring_bank_deductions.php");
...
start_form();
get_branchcode_list_row('Branch:','from_loc',null,'Select Branch');
