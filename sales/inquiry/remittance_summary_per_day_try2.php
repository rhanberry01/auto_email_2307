...
$path_to_root = "../..";
include_once($path_to_root . "/includes/session.inc");
include_once($path_to_root . "/sales/includes/db/sales_remittance_try.inc");
...
$diff = $row['total']- $mycash - $mysrsgc -$mygc - $myterms - $myevoucher-$myricepromo- $myddkita- $mysuki - $mycheck - $mybpidebit- $mybpicredit - $mymetrodebit- $mymetrocredit - $myatd - $myst - $myrec -$mycwtax -$myothers;
	...
	$rep->y++;
															...
															$t_over=abs($over);
																...
																$rep->y++;
																	...
																	$t_t_bpi_dc=$total_t_bpi_dc+$total_t_bpi_dc2;
																	$t_t_bpi_cc=$total_t_bpi_cc+$total_t_bpi_cc2;																	
																	$t_t_metro_dc=$total_t_metro_dc+$total_t_metro_dc2;
																	$t_t_metro_cc=$total_t_metro_cc+$total_t_metro_cc2;
