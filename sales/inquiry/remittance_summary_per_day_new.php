...
$th = array(' ', _("Cashier Name"), _("Reading"), 'Cash', 'SRSGC', 'GC', 'Terms', 'EVoucher', 'Rice Promo','DD-Kita','Suki Card', 'Check', 'Debit','Credit','ATD','ST','Rec.','CWTax','Others','Diff','Short','Over','');
table_header($th);
//---------------------------------------------------------------------------------
...
//$res2=ms_db_query($sql);
															...
															$num_of_cashier = mssql_num_rows($res2);
																...
																$myremitotal_reading2=mysql_total_reading($_POST['date_'],$wholesale_sql2);
																$myremitcash2=mysql_cash($_POST['date_'],$wholesale_sql2);
																$myremitcredit2=mysql_credit($_POST['date_'],$wholesale_sql2);
																$myremitdebit2=mysql_debit($_POST['date_'],$wholesale_sql2);
																$myremitsuki2=mysql_suki($_POST['date_'],$wholesale_sql2);
																$myremitcheck2=mysql_check($_POST['date_'],$wholesale_sql2);
																$myremitsrsgc2=mysql_srsgc($_POST['date_'],$wholesale_sql2);
																$myremitgc2=mysql_gc($_POST['date_'],$wholesale_sql2);
																$myremitterms2=mysql_terms($_POST['date_'],$wholesale_sql2);
																$myremitevoucher2=mysql_evoucher($_POST['date_'],$wholesale_sql2);
																$myremitricepromo2=mysql_rice_promo($_POST['date_'],$wholesale_sql2);
																$myremitddkita2=mysql_ddkita($_POST['date_'],$wholesale_sql2);
																$myremitatd2=mysql_atd($_POST['date_'],$wholesale_sql2);
																$myremitst2=mysql_st($_POST['date_'],$wholesale_sql2);
																$myremitrec2=mysql_receivable($_POST['date_'],$wholesale_sql2);
																$myremitcwtax2=mysql_cw_tax($_POST['date_'],$wholesale_sql2);
																$myremitothers2=mysql_others($_POST['date_'],$wholesale_sql2);				
																$myremitid2=mysql_r_id($_POST['date_'],$wholesale_sql2);
...
//$res3=ms_db_query($sql);
															...
															$num_of_cashier = mssql_num_rows($res3);
																...
																//$myname2=mysql_cashier_name2($_POST['date_'],$wholesale_sql2);
																$myremitotal_reading3=mysql_total_reading($_POST['date_'],$wholesale_sql3);
																$myremitcash3=mysql_cash($_POST['date_'],$wholesale_sql3);
																$myremitcredit3=mysql_credit($_POST['date_'],$wholesale_sql3);
																$myremitdebit3=mysql_debit($_POST['date_'],$wholesale_sql3);
																$myremitsuki3=mysql_suki($_POST['date_'],$wholesale_sql3);
																$myremitcheck3=mysql_check($_POST['date_'],$wholesale_sql3);
																$myremitsrsgc3=mysql_srsgc($_POST['date_'],$wholesale_sql3);
																$myremitgc3=mysql_gc($_POST['date_'],$wholesale_sql3);
																$myremitterms3=mysql_terms($_POST['date_'],$wholesale_sql3);
																$myremitevoucher3=mysql_evoucher($_POST['date_'],$wholesale_sql3);
																$myremitricepromo3=mysql_rice_promo($_POST['date_'],$wholesale_sql3);
																$myremitddkita3=mysql_ddkita($_POST['date_'],$wholesale_sql3);
																$myremitatd3=mysql_atd($_POST['date_'],$wholesale_sql3);
																$myremitst3=mysql_st($_POST['date_'],$wholesale_sql3);
																$myremitrec3=mysql_receivable($_POST['date_'],$wholesale_sql3);
																$myremitcwtax3=mysql_cw_tax($_POST['date_'],$wholesale_sql3);
																$myremitothers3=mysql_others($_POST['date_'],$wholesale_sql3);				
																$myremitid3=mysql_r_id($_POST['date_'],$wholesale_sql3);
																...
																$mycredit3=$myremitcredit3[$row3['uid']];
																$mydebit3=$myremitdebit3[$row3['uid']];
																...
																$diff3 = $row3['total']- $mycash3 - $mysrsgc3 -$mygc3 - $myterms3 - $myevoucher3-$myricepromo3- $myddkita3- $mysuki3 - $mycheck3 - $mydebit3 - $mycredit3 - $myatd3 - $myst3 - $myrec3 - $mycwtax3 -$myothers3;
																	label_cell($c,'align=right');
																	...
																	amount_cell($mydebit3);
																	amount_cell($mycredit3);
																	amount_cell($myatd3);
																	amount_cell($myst3);
																	amount_cell($myrec3);	
																	...
																	$diff3=0;
																	 ...
																	 if($diff3 <= 0)
																	{
																	 label_cell("<b>".number_format2(abs($diff3),3)."<b>",'align=right',true);
																	 label_cell('');
																	 label_cell("<b>".number_format2(abs($diff3),3)."<b>",'align=right',true);
																	 //$over3+=$diff3;
																	}
																	...
																	{
																	 label_cell("<font color=red><b>(".number_format2(abs($diff3),3).")<b></font>",'align=right',true);
																	 label_cell("<font color=red><b>(".number_format2(abs($diff3),3).")<b></font>",'align=right',true);
																	 label_cell('');
																	// $short3+=$diff3;
																	}
																	...
																	$total_t_dc3+=$mydebit3;
																	$total_t_cc3+=$mycredit3;
																	$total_atd3+=$myatd3;
																	$total_st3+=$myst3;
																	$total_rec3+=$myrec3;
															...
															//label_cell("<font color=#880000><b>".number_format3(abs($total_remittance3),2)."<b></font>",'align=right');
															...
															label_cell("<font color=#880000><b>".number_format2(abs($total_t_dc3),2)."<b></font>",'align=right');
															label_cell("<font color=#880000><b>".number_format2(abs($total_t_cc3),2)."<b></font>",'align=right');
															...
															$total_diff3=$simpos_sales3-($total_cash3+$total_srsgc3+$total_gc3+$total_terms3+$total_evoucher3+$total_ricepromo3+$total_ddkita3+$total_t_sc3+$total_t_check3+$total_t_dc3+$total_t_cc3+$total_atd3+$total_st3+$total_rec3+$total_cw_tax3+$total_o3);

															if($total_diff3 <= 0){
															label_cell("<font color=#880000><b>".number_format2(abs($total_diff3),2)."<b></font>",'align=right');
															label_cell("<font color=#880000><b>".number_format2(abs(),2)."<b></font>",'align=right');
															label_cell("<font color=#880000><b>".number_format2(abs($total_diff3),2)."<b></font>",'align=right');
															$t_over=abs($over)+abs($total_diff3);
															$t_short=abs($short);
															}
															else
															{
															...
															label_cell("<font color=#880000><b>".number_format2(abs(),2)."<b></font>",'align=right');
															$t_short=abs($short)+abs($total_diff3);
															$t_over=abs($over);	
															}
															label_cell('');
															end_row();
																	...
																	$t_t_dc=$total_t_dc+$total_t_dc2+$total_t_dc3;
																	$t_t_cc=$total_t_cc+$total_t_cc2+$total_t_cc3;
