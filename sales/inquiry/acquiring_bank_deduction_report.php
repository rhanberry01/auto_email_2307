...
//display_error($acquiring_bank_id);
//start of table display
start_table($table_style2);
$th = array(' ','BankCard', 'Type',  _("Batch#"),  _("Trans#"), _("TransDate"),'DateRemit','Invoice#', 'Merchant ID', 'Card#', 'Amount', 'MerchantFee','WithholdingTax','Debit Net','Credit Net','Date Paid','Remarks');
table_header($th);
