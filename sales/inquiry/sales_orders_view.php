...
$js .= "
	function openThickBox(id,typex,txt){
		url = '../customer_del_so.php?OrderNumber=' + id + '&view=3&type='+typex+'&KeepThis=true&TB_iframe=true&height=280&width=300';
...
{
	global $trans_type;
	if (get_voided_entry($trans_type, $row['order_no']) === false)
