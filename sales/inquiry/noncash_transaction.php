...
if ($myrow["card_desc"]=='') {
label_cell("<font color='RED'>".'NOT INSERTED'.$myrow["card_desc"]."</font>");
}
else if (strpos($myrow["card_desc"]," ")!==false and ($tendercode=='014' or $tendercode=='013')) {
label_cell("<font color='red'>".$myrow["card_desc"]."</font>");
}
else {
