...
while ($myrow = db_fetch($result))
{
	...
	label_cell($myrow["dc_merchant_fee_percent"]);
	label_cell($myrow["cc_merchant_fee_percent"]);
	label_cell($myrow["cc_withholding_tax_percent"]);
...
small_amount_row(_("Debit Card Merchant Rate:"), 'dc_merchant_fee_percent','','','',2);
small_amount_row(_("Credit Card Merchant Rate:"), 'cc_merchant_fee_percent','','','',2);
small_amount_row(_("Creditable Withholding Tax:"), 'cc_withholding_tax_percent','','','',2);
end_table(1);
