...
$_POST['ricepromo_account'],
$_POST['ricepromo_tender'],
$_POST['ddkita_account'],
$_POST['ddkita_tender'],
$_POST['receivable_account'],
$_POST['cwtax_account'],
$_POST['atd_account'],
$_POST['stock_transfer_account'],
...
$_POST['ricepromo_account'] = $myrow["ricepromo_account"];
$_POST['ricepromo_tender'] = $myrow["ricepromo_tender"];
$_POST['ddkita_account'] = $myrow["ddkita_account"];
$_POST['ddkita_tender'] = $myrow["ddkita_tender"];
$_POST['receivable_account'] = $myrow["receivable_account"];
$_POST['cwtax_account'] = $myrow["cwtax_account"];
$_POST['atd_account'] = $myrow["atd"];
$_POST['stock_transfer_account'] = $myrow["stock_transfer"];
...
gl_all_accounts_list_row(_("Rice Promo Account:"), 'ricepromo_account', $_POST['ricepromo_account']);
tender_list_row("Rice Promo Tender Type:", 'ricepromo_tender',  $_POST['ricepromo_tender']); 
gl_all_accounts_list_row(_("Dagdag Kita Account:"), 'ddkita_account', $_POST['ddkita_account']);
tender_list_row("Dagdag Kita Tender Type:", 'ddkita_tender',  $_POST['ddkita_tender']); 
gl_all_accounts_list_row(_("ATD Account:"), 'atd_account', $_POST['atd_account']);
gl_all_accounts_list_row(_("Stock Transfer Account:"), 'stock_transfer_account', $_POST['stock_transfer_account']);
gl_all_accounts_list_row(_("Receivable Account:"), 'receivable_account', $_POST['receivable_account']);
gl_all_accounts_list_row(_("CWTax Account:"), 'cwtax_account', $_POST['cwtax_account']);
