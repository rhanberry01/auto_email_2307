...
{
	if($trans["type"] != ST_CUSTCREDITMEMO)
		return get_trans_view_str($trans["type"], $trans["trans_no"]);
	else
		return get_gl_view_str($trans["type"], $trans["trans_no"], $trans["trans_no"]);
}
...
$cols = array(
	_("Transaction Type") => array('fun'=>'systype_name', 'type'=>'nowrap'),
...
$table->set_marker('check_settled', _("Highlighted items are settled."), 'settledbg', 'settledfg');
