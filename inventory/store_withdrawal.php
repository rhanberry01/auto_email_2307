...
include_once($path_to_root . "/inventory/includes/sa_to_kusina_ui.inc");
...
page(_($help_context = "Stock Transfer (Stocks Withdrawal)"), false, false, "", $js);
...
global $db_connections;
	...
	$trans_no = transfer_to_resto($_SESSION['transfer_items']->line_items,
	...
	// $trans_no = receive_from_resto($_SESSION['transfer_items']->line_items,
	// $_POST['FromStockLocation'],$_POST['ToStockLocation'], $_POST['AdjDate'],$_POST['type'],
	// $_POST['ref'], $_POST['memo_'],$_POST['BrLocation1'],$_POST['BrLocation2']);
...
display_withdrawal_header($_SESSION['transfer_items']);

start_table("$table_style width=80%", 10);
start_row();
echo "<td>";
display_transfer_items(_("Stocks to Withdraw"), $_SESSION['transfer_items']);
