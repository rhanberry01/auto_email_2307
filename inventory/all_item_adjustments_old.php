...
include_once($path_to_root . "/inventory/includes/all_item_adjustments_ui_old.inc");
include_once($path_to_root . "/inventory/includes/db/all_item_adjustments_db_old.inc");
$js = "";
$js .= "
