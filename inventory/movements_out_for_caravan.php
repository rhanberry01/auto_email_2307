...
if (isset($_POST['Process']) && can_process()){
	...
	$trans_no = new_stock_transfer_out_caravan($_SESSION['adj_items']->line_items,
...
if($from_br_code =='srscain2'){
	start_form();
	$from_br_code=$db_connections[$_SESSION["wa_current_user"]->company]["br_code"];
	display_order_header($_SESSION['adj_items'],$_GET['trans_no'],$from_br_code,1);
	...
	display_error('PLEASE LOG IN TO CAINTA2 BRANCH');
}
