...
$th = array();
// ============================================== 
array_push($th, 'Branch', 'Date Created', 'TransNo','MovementNo','Movement Type', 'Created By', 'Date Posted', 'Approved By','Posted By', 'Status','Extended','','','Purchaser '.'<input type="checkbox" id="purch_all">', 'Operations '.'<input type="checkbox" id="post_all">', 'GM '.'<input type="checkbox" id="approve_all">');
