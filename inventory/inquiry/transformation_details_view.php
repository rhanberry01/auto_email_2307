...
$sql = "select * from ".TB_PREF."transformation_header where a_trans_no='$trans_no' and a_type='$type'";
...
$sql="SELECT * FROM ".TB_PREF."transformation_header as th 
LEFT JOIN ".TB_PREF."transformation_details as td
