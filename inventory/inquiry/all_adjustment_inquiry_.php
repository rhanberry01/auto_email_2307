...
if ($_POST['start_date'])
{
	$sql .= " WHERE a_date_created >= '".date2sql($_POST['start_date'])."'
			  AND a_date_created<= '".date2sql($_POST['end_date'])."'";	
}
...
{
$sql .= " AND a_status = '$stats'";	
}


$sql .= " ORDER BY a_date_created";
$res = db_query($sql);
//display_error($sql);
