...
function send_that_cv($cv_id,$show_gl)
{
	...
	<p><a href='http://srsemailverify.hopto.org/srs_aria_test/gl/inquiry/csv_inquiry2_verify.php?cv_no=$cv_id'>verified</a>
	...
	$mail->AddAddress(trim('bataljade9614@gmail.com'), 'Juan Dela Cruz');
	...
	global $db_connections;
		...
		if(!$mail->Send()) 
		{
			display_error("Failed to send email to (" . str_replace("@", "&#64;", 'bataljade9614@gmail.com') . ') ' 
				. $mail->ErrorInfo . '<br />');
				
			$mail->ClearAddresses();
			$mail->ClearAttachments();
			return ("Failed to send email to (" . str_replace("@", "&#64;", 'bataljade9614@gmail.com') . ') ' 
				. $mail->ErrorInfo . '<br />');
		}
		else 
		{
			...
			$mail->ClearAddresses();
			$mail->ClearAttachments();
			display_notification("Message sent tos :" . $supp_row["pay_to"] .
				' (' . str_replace("@", "&#64;", $supp_row['email']) . ')<br />');
				
			// return ("Message sent to :" . $supp_row["pay_to"] .
			// 	' (' . str_replace("@", "&#64;", 'bataljade9614@gmail.com') . ')<br />');
