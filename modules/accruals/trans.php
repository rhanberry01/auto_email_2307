...
page("Search General Ledger Transactions for account: ".$_GET['act'], true);
...
display_heading("Search General Ledger Transactions for account: ".$_GET['act']. " ".get_gl_account_name($_GET['act']));
...
$remaining_cols = array("Person/Item", "Debit", "Credit", "Memo");
