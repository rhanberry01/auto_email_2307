...
$th = array(' ','BankCard', 'Type',  _("Trans#"), _("TransDate"),'DateRemit','Invoice#', 'Terminal ID', 'Card#', 'Approval#', 'Amount', 'MerchantFee','WTax','Debit Net','Credit Net','Date Paid');
...
$sql.=" ORDER BY p_terminal_id, p_invoice_no asc";
...
//display_error($sql);
	...
	$x++;
		...
		$x++;
		$rep->sheet->writeNumber($rep->y, $x, $row['p_amount'], $format_accounting);
		$x++;
	...
	$x++;
	$rep->sheet->writeNumber($rep->y, $x, $t_amount, $format_accounting);
	$x++;
...
$th = array(' ','BankCard', 'Type',  _("Trans#"), _("TransDate"),'DateRemit','Invoice#', 'Terminal ID', 'Card#', 'Approval#', 'Amount', 'MerchantFee','WithholdingTax','Debit Net','Credit Net','Date Paid');
table_header($th);
